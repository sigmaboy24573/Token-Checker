...
def update_title(num_tokens):
    while True:
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(f" {hours:02d}:{minutes:02d}:{seconds:02d} | Bluewave Market | Bluewave Checker | https://discord.gg/8Z2r9qjdCr | FOUND {num_tokens} TOKENS | Generated: {num_generated_tokens}")
        time.sleep(1)
